...
internal sealed class Visa32
{
    ...
    //  Some minor changes were made to this file by Ed Paay of Tech-Relief LLC
    //  These calls are documented at:
    ...
    #region Visa Code Xlat

    public enum ViReturnLevel
    {
        OK,
        Warning,
        Error,
    ...
    public static ViReturnLevel ReturnLevel(int code)
    {
        return code switch
        {
            VI_SUCCESS or VI_SUCCESS_EVENT_EN or VI_SUCCESS_EVENT_DIS or VI_SUCCESS_QUEUE_EMPTY or VI_SUCCESS_TERM_CHAR or 
            VI_SUCCESS_MAX_CNT or VI_SUCCESS_DEV_NPRESENT or VI_SUCCESS_TRIG_MAPPED or VI_SUCCESS_QUEUE_NEMPTY or 
            VI_SUCCESS_NCHAIN or VI_SUCCESS_NESTED_SHARED or VI_SUCCESS_NESTED_EXCLUSIVE or VI_SUCCESS_SYNC => ViReturnLevel.OK,
            VI_WARN_QUEUE_OVERFLOW or VI_WARN_CONFIG_NLOADED or VI_WARN_NULL_OBJECT or VI_WARN_NSUP_ATTR_STATE or 
            VI_WARN_UNKNOWN_STATUS or VI_WARN_NSUP_BUF or VI_WARN_EXT_FUNC_NIMPL => ViReturnLevel.Warning,
            VI_ERROR_SYSTEM_ERROR or VI_ERROR_INV_OBJECT or VI_ERROR_RSRC_LOCKED or VI_ERROR_INV_EXPR or VI_ERROR_RSRC_NFOUND or 
            VI_ERROR_INV_RSRC_NAME or VI_ERROR_INV_ACC_MODE or VI_ERROR_TMO or VI_ERROR_CLOSING_FAILED or VI_ERROR_INV_DEGREE or 
            VI_ERROR_INV_JOB_ID or VI_ERROR_NSUP_ATTR or VI_ERROR_NSUP_ATTR_STATE or VI_ERROR_ATTR_READONLY or 
            VI_ERROR_INV_LOCK_TYPE or VI_ERROR_INV_ACCESS_KEY or VI_ERROR_INV_EVENT or VI_ERROR_INV_MECH or 
            VI_ERROR_HNDLR_NINSTALLED or VI_ERROR_INV_HNDLR_REF or VI_ERROR_INV_CONTEXT or VI_ERROR_QUEUE_OVERFLOW or 
            VI_ERROR_NENABLED or VI_ERROR_ABORT or VI_ERROR_RAW_WR_PROT_VIOL or VI_ERROR_RAW_RD_PROT_VIOL or 
            VI_ERROR_OUTP_PROT_VIOL or VI_ERROR_INP_PROT_VIOL or VI_ERROR_BERR or VI_ERROR_IN_PROGRESS or VI_ERROR_INV_SETUP or 
            VI_ERROR_QUEUE_ERROR or VI_ERROR_ALLOC or VI_ERROR_INV_MASK or VI_ERROR_IO or VI_ERROR_INV_FMT or VI_ERROR_NSUP_FMT or 
            VI_ERROR_LINE_IN_USE or VI_ERROR_NSUP_MODE or VI_ERROR_SRQ_NOCCURRED or VI_ERROR_INV_SPACE or VI_ERROR_INV_OFFSET or 
            VI_ERROR_INV_WIDTH or VI_ERROR_NSUP_OFFSET or VI_ERROR_NSUP_VAR_WIDTH or VI_ERROR_WINDOW_NMAPPED or 
            VI_ERROR_RESP_PENDING or VI_ERROR_NLISTENERS or VI_ERROR_NCIC or VI_ERROR_NSYS_CNTLR or VI_ERROR_NSUP_OPER or
            VI_ERROR_INTR_PENDING or VI_ERROR_ASRL_PARITY or VI_ERROR_ASRL_FRAMING or VI_ERROR_ASRL_OVERRUN or 
            VI_ERROR_TRIG_NMAPPED or VI_ERROR_NSUP_ALIGN_OFFSET or VI_ERROR_USER_BUF or VI_ERROR_RSRC_BUSY or VI_ERROR_NSUP_WIDTH 
            or VI_ERROR_INV_PARAMETER or VI_ERROR_INV_PROT or VI_ERROR_INV_SIZE or VI_ERROR_WINDOW_MAPPED or VI_ERROR_NIMPL_OPER 
            or VI_ERROR_INV_LENGTH or VI_ERROR_INV_MODE or VI_ERROR_SESN_NLOCKED or VI_ERROR_MEM_NSHARED or 
            VI_ERROR_LIBRARY_NFOUND or VI_ERROR_NSUP_INTR or VI_ERROR_INV_LINE or VI_ERROR_FILE_ACCESS or VI_ERROR_FILE_IO or 
            VI_ERROR_NSUP_LINE or VI_ERROR_NSUP_MECH or VI_ERROR_INTF_NUM_NCONFIG or VI_ERROR_CONN_LOST or VI_ERROR_MACHINE_NAVAIL 
            or VI_ERROR_NPERMISSION => ViReturnLevel.Error,
            _ => ViReturnLevel.Undefined,
        };
    }
    #endregion Visa Code Xlat
